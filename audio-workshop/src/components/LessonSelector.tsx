...
const lessons = [
  ...
  },
  {
    ...
    image: 'https://upload.wikimedia.org/wikipedia/commons/thumb/0/03/Dbx%2C_Inc._audio_compressors_on_a_rack_%28cropped%29.jpg/960px-Dbx%2C_Inc._audio_compressors_on_a_rack_%28cropped%29.jpg',
    icon: <Waves className="w-8 h-8" />,
    color: 'from-purple-600 to-pink-500',
    badge: '16 slides',
  },
  {
    ...
    image: 'https://upload.wikimedia.org/wikipedia/commons/thumb/0/0f/Interference_of_two_waves.svg/960px-Interference_of_two_waves.svg.png',
    icon: <Waves className="w-8 h-8" />,
  ...
  },
  {
    ...
    image: 'https://upload.wikimedia.org/wikipedia/commons/thumb/e/eb/Microphone.JPG/960px-Microphone.JPG',
    icon: <Waves className="w-8 h-8" />,
  ...
  },
  {
    ...
    image: 'https://upload.wikimedia.org/wikipedia/commons/thumb/c/ce/Wall_of_Sound_%28QuadFest%29.jpg/960px-Wall_of_Sound_%28QuadFest%29.jpg',
