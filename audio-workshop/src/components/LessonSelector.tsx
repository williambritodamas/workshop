...
const lessons = [
  ...
  },
  {
    ...
    image: 'https://commons.wikimedia.org/wiki/Special:FilePath/Dbx%2C%20Inc.%20audio%20compressors%20on%20a%20rack%20(cropped).jpg?width=800',
    icon: <Waves className="w-8 h-8" />,
    color: 'from-purple-600 to-pink-500',
    badge: '16 slides',
  },
  {
    ...
    image: 'https://commons.wikimedia.org/wiki/Special:FilePath/Interference_of_two_waves.svg?width=800',
    icon: <Waves className="w-8 h-8" />,
