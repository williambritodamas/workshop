...
export const Slide16_Closing: React.FC = () => (
  <div className="relative w-full h-full flex flex-col justify-between items-center text-center p-8 md:p-16 overflow-hidden">
    <div className="absolute inset-0 z-0">
      <img src="https://images.pexels.com/photos/11884526/pexels-photo-11884526.jpeg?auto=compress&cs=tinysrgb&w=1920" alt="Mesa de som" className="w-full h-full object-cover opacity-20 scale-105" />
    ...
    <div className="relative z-10 max-w-4xl flex flex-col items-center my-auto">
      <motion.div initial={{ opacity: 0, scale: 0.8 }} animate={{ opacity: 1, scale: 1 }} transition={{ duration: 0.5 }}>
        <div className="p-4 rounded-2xl bg-amber-500/10 border border-amber-500/30 text-amber-400 mb-6">
      ...
      >
        Você chegou ao{' '}
        <span className="bg-gradient-to-r from-amber-400 to-orange-400 bg-clip-text text-transparent">topo</span>
      </motion.h1>
      ...
      >
        Gain, Fader, Clip e Headroom — você agora sabe controlar o coração de qualquer sistema de áudio.
      </motion.p>
      ...
      >
        ...
        <span>"Quem controla bem o ganho resolve metade dos problemas de um sistema de áudio."</span>
      </motion.div>
    </div>
    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 1.2 }}
      className="relative z-10 text-slate-500 text-xs flex items-center gap-2"
    >
      <span>Próxima aula: Equalização</span>
