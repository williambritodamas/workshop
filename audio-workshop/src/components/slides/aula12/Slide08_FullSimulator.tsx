...
export const Slide08_FullSimulator: React.FC = () => (
  <div className="relative w-full h-full flex flex-col justify-between items-center p-8 md:p-12 overflow-hidden">
    <div className="absolute inset-0 z-0">
      <img src="https://images.pexels.com/photos/169720/pexels-photo-169720.jpeg?auto=compress&cs=tinysrgb&w=1920" alt="Palco" className="w-full h-full object-cover opacity-10" />
