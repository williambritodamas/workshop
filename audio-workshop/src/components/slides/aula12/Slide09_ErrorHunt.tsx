...
export const Slide09_ErrorHunt: React.FC = () => {
  ...
  return (
    <div className="relative w-full flex-1 flex flex-col justify-between items-center p-6 md:p-12 overflow-y-auto">
      <div className="absolute inset-0 z-0">
        <img src="/images/wall-of-sound.jpg" alt="Palco" className="w-full h-full object-cover opacity-10" />
