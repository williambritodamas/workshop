...
export const Slide01_Opening: React.FC = () => (
  <div className="relative w-full h-full flex flex-col justify-between items-center text-center p-8 md:p-16 overflow-hidden">
    <div className="absolute inset-0 z-0">
      <img src="https://images.pexels.com/photos/185392/pexels-photo-185392.jpeg?auto=compress&cs=tinysrgb&w=1920" alt="Ondas sonoras abstratas" className="w-full h-full object-cover opacity-35 scale-105" />
