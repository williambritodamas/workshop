    ...
    <div className="relative w-full flex-1 flex flex-col justify-between items-center p-8 md:p-12 overflow-y-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 w-full max-w-5xl my-auto">
        ...
        <motion.div
          ...
          className="flex flex-col items-center rounded-3xl bg-slate-900/80 border border-slate-800 p-6 overflow-y-auto relative group hover:border-blue-500/50 transition-all shadow-xl"
        >
          <div className="relative w-full h-56 md:h-64 rounded-2xl overflow-y-auto mb-6">
            <img
